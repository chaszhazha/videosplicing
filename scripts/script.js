$(document).ready(function(){
	...
	var videos = [new VideoClip({vid:"mYIfiQlfaas", start: 85.0, duration: 15.0, video_length:217.0 , source:"youtube" }),
			new VideoClip({video_url: "http://globalshakespeares.mit.edu/media/hamlet-maestri-maria-federica-2011.mov", start:100.0, duration:20.0, video_length:3647.120, source:"qt", thumbnailurl:"http://globalshakespeares.mit.edu/media/hamlet-maestri-maria-federica-2011.jpg/228/174/"}),
