$(document).ready(function(){
	...
	videos[0].annotations.push(new VideoAnnotation({content:"This is test annotation 1 for video 1", position: 88, duration:7, rect:{top:10, bottom:160, left:10, right:170}}));
	videos[1].annotations.push(new VideoAnnotation({content:"This is test annotation 2 for video 2", position: 27, duration:7, rect:{top:20, bottom:170, left:10, right:170}}));
	videos[2].annotations.push(new VideoAnnotation({content:"This is test annotation 3 for video 3", position: 120, duration:7, rect:{top:30, bottom:180, left:10, right:170}}));
